...
This project demonstrates **neuromorphic-inspired learning**: a robot navigates a dynamic 10×10 grid environment (Hospital or Warehouse), learning to avoid moving and static obstacles using **Q-learning reinforcement learning**. Over 10 episodes, the robot progresses from random exploration to smooth, collision-free navigation — mirroring how humans develop reflexes through repeated experience.
